...
@section('content')
  <div class="bg-gray-900 px-20 py-16 rounded-lg mb-8 relative overflow-hidden">
    <span class="text-xs uppercase text-gray-700 bg-gray-400 rounded-full px-2 py-1">Programing</span>
    <h1 class="text-3xl text-white mt-4">Blog</h1>
    <p class="text-sm text-gray-400 mt-2">Web project</p>
    <img src="{{ asset('images/dev.png') }}" alt="Imagen dev" class="absolute -right-20 -bottom-20 opacity-20">
  </div>
  <article class="px-4">
    <h1 class="text-2xl mb-8 text-gray-900">Articles</h1>
